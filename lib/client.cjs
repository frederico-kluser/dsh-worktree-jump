	...
	factory: (require) => {
		...
		*/
		function WorktreeAction(props) {
			...
			const [heroRow, setHeroRow] = (0, react.useState)(void 0);
			(0, react.useEffect)(() => {
			...
			const visible = blank && cwd !== void 0 && cwd !== "" && status !== void 0 && status.isGitRepo;
			(0, react.useEffect)(() => {
				if (!visible) {
					setHeroRow(void 0);
					return;
				...
				const resolve = () => {
					...
					if (chip !== null) {
						setHeroRow(chip.parentElement ?? void 0);
						observer?.disconnect();
						observer = null;
					}
				};
			...
			if (heroRow === void 0) return null;
			const repoName = cwd.split("/").filter((part) => part !== "").at(-1) ?? cwd;
			const triggerStyle = {
				...styles.trigger,
				...hovered ? styles.triggerHover : void 0
			};
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_dom.createPortal)((0, react_jsx_runtime.jsxs)("button", {
				type: "button",
				onPointerDown: (event) => {
			...
			}), heroRow), (0, react_jsx_runtime.jsx)(WorktreeDialog, {
				open: dialogOpen,
				onClose: () => {
					setDialogOpen(false);
				},
