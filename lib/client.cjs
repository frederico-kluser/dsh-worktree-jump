		...
		function WorktreeAction(props) {
			...
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)("div", {
				...
				children: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
					label: t("button.tooltip", { repo: repoName }),
					side: "bottom",
					children: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
						variant: "outline",
						size: "sm",
						icon: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconBranchOutline16, { size: 14 }),
			...
			return (0, react_jsx_runtime.jsxs)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
				...
				children: [
					...
					existing.length > 0 ? (0, react_jsx_runtime.jsxs)("details", {
						...
						children: [(0, react_jsx_runtime.jsx)("summary", { children: `${t("dialog.existing")} (${String(existing.length)})` }), (0, react_jsx_runtime.jsx)("ul", {
							style: styles.existingList,
							children: existing.map((worktree) => (0, react_jsx_runtime.jsxs)("li", {
								style: {
									overflow: "hidden",
									textOverflow: "ellipsis",
									whiteSpace: "nowrap"
								...
								children: [
									...
									" ",
									(0, react_jsx_runtime.jsx)("code", { children: worktree.path })
								]
							}, worktree.path))
						})]
					}) : void 0,
